...
juce::PluginLicensorStatus::PluginLicensorStatus ()
{
}
 ...
 * @return false
 */
bool juce::PluginLicensorStatus::withholdInfo ()
{
    return false;
}
 ...
 * @return juce::String
 */
juce::String juce::PluginLicensorStatus::getClientLanguage ()
{
    return "English";
}
 ...
 * @return juce::RSAKey
 */
juce::RSAKey juce::PluginLicensorStatus::getPublicKey ()
{
...
/**
  * This URL will be displayed to the user, but it doesn't have to be a real URL...
  * You could set it to "God" or something, where the UI says "Connecting with God"
  * And then you could adjust the custom responses the server sends using the console...
  **** Use with moderation.
  */
juce::String juce::PluginLicensorStatus::getWebsiteName ()
{
 ...
 * @return juce::String
 */
juce::String juce::PluginLicensorStatus::getCompanyID ()
{
    return "TESTCOMP1";
}
 ...
 * @return juce::String
 */
juce::String juce::PluginLicensorStatus::getProductID ()
{
    return "TESTPLUGIN1";
}
...
/**
  ...
  */
juce::URL juce::PluginLicensorStatus::getServerAuthenticationURL ()
{
